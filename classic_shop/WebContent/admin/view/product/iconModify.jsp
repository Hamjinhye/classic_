				...
				<div class="container row mb-1">
						...
						<div class="col-md-3">
							<div class="row mb-1">
								...
								<div class="col-md-6">
									<button class="col-md-12 btn btn-outline-danger btn-lg" data-toggle="modal" data-target="#myModal">수정</button>
								</div>
							</div>
						</div>
				</div>
							...
							<table class="table col-md-12">
								<tr class="row">
									...
									<td class="col-md-10 container">
										<input class="col-md-5" type="text" placeholder="베스트 상품">
								...
								<tr class="row">
									...
									<td class="col-md-10 container">
										<input class="col-md-5" type="text" placeholder="icon0001">
									</td>
								</tr>
								<tr class="row">
