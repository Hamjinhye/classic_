...
public interface QnaDAO {
	...
	public List<QnaDTO> selectMemQna(int mem_num, PagingDTO pagingDTO)throws Exception; //특정회원이 쓴 qna 글(mypage)
	...
	public int qnaMemTotalRecord(int mem_num) throws Exception; //특정회원의 qna 글 수(mypage paging)
